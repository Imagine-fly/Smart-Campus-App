...
public class UnderstanderDemo extends Activity implements OnClickListener {
	...
	public void onClick(View view) {
		if(view.getId() == R.id.image_understander_set)// 进入参数设置页面
		{
			Intent intent = new Intent(UnderstanderDemo.this, UnderstanderSettings.class);
			startActivity(intent);
		}
		else if(view.getId() == R.id.text_understander)// 开始文本理解
		{
		...
		}else if(view.getId() == R.id.start_understander)// 开始语音理解
		{
			mUnderstanderText.setText("");
			// 设置参数
			setParam();
		...
		}else if(view.getId() == R.id.understander_stop)// 停止语音理解
		{
			mSpeechUnderstander.stopUnderstanding();
			showTip("停止语义理解");
		}else if(view.getId() == R.id.understander_cancel)// 取消语音理解
		{
